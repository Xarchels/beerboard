...
public interface BiereRepository extends CrudRepository<Biere, BiereId> {
    ...
    @Query("select distinct b from Biere b where b.marque.brasserie.codeBrasserie = :code order by b.marque.nomMarque asc, b.version asc")
    public ArrayList getBiereFromBrasserie(@Param("code") String code);
}
